...
const GradientBanner = ({ text }) => {
  ...
  const isAllowedRoute = ['CreateGame', 'Swagger', 'Profile', 'Candidate', 'Upload','Constitution', 'WinnerDisplay', 'EditConstitution','EditDistrict','Theme','Menu'].includes(route.name) && jwtToken;
