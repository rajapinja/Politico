...
import { View, TouchableOpacity, StyleSheet, ImageBackground, Text, FlatList, ScrollView, VirtualizedList } from 'react-native';
...
const ConstitutionScreen = ({ navigation }) => {
    ...
    // const totalPages = Math.ceil(constitutions.length / ITEMS_PER_PAGE);
    ...
    //  Virtualized List
    const getItemCount = () => constitutions.length;
    const getItem = (constitutions, index) => constitutions[index];

    const renderItem = ({ item }) => (
        <View style={styles.dataRow}>
            <Text style={styles.dataCell}>{item.name.toLowerCase()}</Text>
            <Text style={styles.dataCell}>{item.c_number}</Text>
                ...
                <View style={styles.container}>
                    <View style={styles.pageContent}>
                        ...
                        <View style={styles.InputRow}>
                            ...
                            >
                                <Text style={styles.buttonText}> GET CONSTITUTIONS</Text>
                            </TouchableOpacity>
                        </View>
                        <View style={styles.rowWrapper}>                           
                            <VirtualizedList style={styles.flatListWrapper}
                                data={constitutions}
